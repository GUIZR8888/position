...
model = ChatOpenAI(
    ...
    api_key="fcd02a02ad1343cb77d547e313a14cdc.KsXK5ughrSvCuKco" # 账号信息
)
# 创建记忆模块对象 记忆模块需要结合提示词模块使用，记忆模块保存的数据当作提示词信息传递给大模型即可
if "memory" not in st.session_state:
    st.session_state.memory = ConversationBufferMemory(memory_key="history")
# 创建提示词对象
prompt = PromptTemplate.from_template("你叫GGBoy，你现在扮演的是一个侠义英雄的角色，你现在要和你的敌人对话，你敌人的话是{input},你需要对你敌人的话做出回应，而且只做回应，你和你敌人的历史对话为{history}")
...
# 创建一个聊天输入框
problem = st.chat_input("你的GGBoy正在等待你的回应")
